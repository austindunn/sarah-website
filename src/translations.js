const translations = {
  en: {
    // Page titles
    title_home:             "Sarah Foulkes — Filmmaker & Writer",
    title_about:            "About — Sarah Foulkes",
    ...
    // Home
    hero_tagline: "<em>Filmmaker &amp; writer</em>",
    ...
    sf_synopsis: "Special Features is a meta short film that explores the blurry boundaries between fiction and memory.",
  ...
  fr: {
    // Page titles
    title_home:             "Sarah Foulkes — Cinéaste & écrivaine",
    title_about:            "À propos — Sarah Foulkes",
    title_films:            "Films — Sarah Foulkes",
    title_soft_lock:        "Soft Lock — Sarah Foulkes",
    title_yntayd:           "You Never Talk About Your Dreams — Sarah Foulkes",
    title_contours:         "Contours — Sarah Foulkes",
    ...
    // Home
    hero_tagline: "<em>Cinéaste &amp; écrivaine</em>",
...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var toggle = document.querySelector(".nav-lang");
    if (toggle) {
